...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'password' => ['type' => 'string', 'length' => 2555, 'null' => false, 'default' => null, 'collate' => 'utf32_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-10-01 09:55:31',
                'modified' => '2019-10-01 09:55:31'
            ],
        ];
        parent::init();
    }
